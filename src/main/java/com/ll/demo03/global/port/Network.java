...
public interface Network {
    ...
    String createImage(Long taskId, String checkpoint, String lora, String prompt, int width, int height, String webhook);
    String createImageFaceDetailer(Long taskId, String checkpoint, String lora, String prompt, int width, int height, String webhook);
